...
ga( "band 1's own max-w-4xl cap (the root IS the capped box) → container width Medium (896px)", 'medium' === ( $u_pg[0]['atts']['container_width']['preset'] ?? '' ) );
...
ga( "…the form's card skin rides the column as a Box Preset with its 32px inset", is_array( $x_formcol ) && false !== strpos( (string) ( $x_formcol['atts']['custom_css'] ?? '' ), 'padding-top:32px' ), wp_json_encode( $x_formcol['atts']['custom_css'] ?? null ) );
